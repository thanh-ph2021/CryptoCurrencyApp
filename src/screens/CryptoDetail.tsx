...
const CryptoDetail = ({ route, navigation }: any) => {
    ...
    const [chartOptions, setChartOptions] = React.useState<any>(dummyData.chartOptions)
    const [selectedOption, setSelectedOption] = React.useState<any>(chartOptions[0])
    ...
    function optionOnclickHandler(option: any) {
                ...
                >
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center'}}>
                        <View style={{ marginRight: SIZES.base}}>
                            ...
                            <Text style={{ textAlign: 'right', color: COLORS.gray, ...FONTS.h3}}>{selectedCurrency?.wallet.crypto} {selectedCurrency?.code}</Text>
                        </View>
                        <Image 
